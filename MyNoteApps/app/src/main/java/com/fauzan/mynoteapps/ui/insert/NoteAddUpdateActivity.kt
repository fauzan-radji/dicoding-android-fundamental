package com.fauzan.mynoteapps.ui.insert
...
import com.fauzan.mynoteapps.R
import com.fauzan.mynoteapps.database.Note
import com.fauzan.mynoteapps.databinding.ActivityNoteAddUpdateBinding
import com.fauzan.mynoteapps.helper.DateHelper
import com.fauzan.mynoteapps.helper.ViewModelFactory
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_delete -> showAlertDialog(ALERT_DIALOG_DELTE)
