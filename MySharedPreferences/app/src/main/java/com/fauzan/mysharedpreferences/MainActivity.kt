package com.fauzan.mysharedpreferences
...
import com.fauzan.mysharedpreferences.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(btn: View) {
        if (btn.id == R.id.btn_save) {
            ...
            intent.putExtra(FormUserPreferenceActivity.EXTRA_USER, userModel)
